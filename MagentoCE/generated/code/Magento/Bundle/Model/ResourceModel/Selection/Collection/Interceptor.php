...
class Interceptor extends \Magento\Bundle\Model\ResourceModel\Selection\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_afterLoad');
        if (!$pluginInfo) {
            return parent::_afterLoad();
        } else {
            return $this->___callPlugins('_afterLoad', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinPrices');
        if (!$pluginInfo) {
            return parent::joinPrices($websiteId);
        } else {
            return $this->___callPlugins('joinPrices', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setOptionIdsFilter');
        if (!$pluginInfo) {
            return parent::setOptionIdsFilter($optionIds);
        } else {
            return $this->___callPlugins('setOptionIdsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSelectionIdsFilter');
        if (!$pluginInfo) {
            return parent::setSelectionIdsFilter($selectionIds);
        } else {
            return $this->___callPlugins('setSelectionIdsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setPositionOrder()
    {
        ...
        if (!$pluginInfo) {
            return parent::setPositionOrder();
        } else {
            return $this->___callPlugins('setPositionOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addQuantityFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addQuantityFilter();
        } else {
            return $this->___callPlugins('addQuantityFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPriceFilter');
        if (!$pluginInfo) {
            return parent::addPriceFilter($product, $searchMin, $useRegularPrice);
        } else {
            return $this->___callPlugins('addPriceFilter', func_get_args(), $pluginInfo);
        }
    }
